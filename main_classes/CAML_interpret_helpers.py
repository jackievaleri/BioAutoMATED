...
def get_std_dev_at_each_bp(df, smallalph, num_seqs_to_test):
    """get the standard deviation across all of the monomers for each of the sequences (one monomer at a time)
    Parameters
    ----------
...
def plot_rawseqlogos(arr, fullalph, sequence_type, plot_path, plot_name, lenarr):
    ...
    # the columns are the alphabet letters and the rows are position-wise probabilities of monomer composiiton
