...
def final_plot(dfplot, plot_path, plot_name):
    ...
    for name, smalldf in dfplot.groupby('Method Type'):
        ...
        sns.violinplot(
            ...
            saturation = 0.6,   linewidth=0.75, fliersize=1)
        ...
        plt.savefig(plot_path + name + '_violinplot' + plot_name + '.svg')
        plt.show()
    ...
    for method, smalldf in dfplot.groupby('Method Type'):
        ...
        print('Comparing original to mutated: ', sp.ttest_ind(original['preds'], mutated['preds']))
    
        if len(storm) > 0:
            print('Comparing original to STORM: ', sp.ttest_ind(original['preds'], storm['preds']))
            print('Comparing mutated to STORM: ', sp.ttest_ind(mutated['preds'], storm['preds']))
