...
from interpret_helpers import plot_mutagenesis, plot_rawseqlogos, plot_activation_maps, plot_saliency_maps, plot_seqlogos
...
class DeepSwarmClassification(AutoMLClassifier): 
    ...
    def convert_input(self): 
        ...
        return convert_generic_input(self.df_data_input, self.df_data_output, self.pad_seqs, self.augment_data, self.sequence_type, model_type = 'deepswarm')
    ...
    def update_yaml_file(self, input_shape):
        ...
        None
        """
        # due to technicality in deepswarm installation, default.yaml file must always be at settings/default.yaml
    ...
    def run_system(self): 
        ...
        with suppress_stdout(self.verbosity):
            ...
            compiled_seqs, compiled_true, compiled_preds = self.bin_train_architecture_helper(X, y, transform_obj,seed,alph,output_folder_mod='deepswarm_')
        ...
        if self.dataset_robustness:
            ...
            while dataset_size > 1000:
                ...
                with suppress_stdout(self.verbosity):
                    _, _, _ = self.bin_train_architecture_helper(X[0:dataset_size], y[0:dataset_size], transform_obj,seed,alph,output_folder_mod='robustness/' + str(dataset_size) + '_', subset = str(dataset_size))
...
class DeepSwarmRegression(AutoMLRegressor): 
    ...
    def run_system(self):
        ...
        with suppress_stdout(self.verbosity):
            ...
            compiled_seqs, compiled_true, compiled_preds = self.reg_train_architecture_helper(X, y, transform_obj,seed,alph, output_folder_mod='deepswarm_')
