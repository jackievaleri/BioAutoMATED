...
########### end seqprop optimize ###########

########### other seqprop funcs - custom for bioseqml ###########
...
# adapted from: https://github.com/876lkj/seqprop 
def build_predictor(generator_model, load_predictor_function, final_model_path, n_sequences=1, n_samples=None, eval_mode='pwm') : # adapted from seqprop package to take chnage shape of seq_input for DS models
