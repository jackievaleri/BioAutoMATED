...
# Average CV score on the training set was: 0.8945846390470275
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=DecisionTreeClassifier(criterion="entropy", max_depth=5, min_samples_leaf=11, min_samples_split=8)),
