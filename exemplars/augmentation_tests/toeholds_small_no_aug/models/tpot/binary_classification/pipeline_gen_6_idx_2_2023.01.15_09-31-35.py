...
# Average CV score on the training set was: 0.8264110275689223
exported_pipeline = make_pipeline(
    ...
    XGBClassifier(learning_rate=1.0, max_depth=9, min_child_weight=8, n_estimators=100, n_jobs=1, subsample=1.0, verbosity=0)
)
